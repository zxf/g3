...
function loadStarSurfaceTextures(){
	if( sunTexture === undefined ){
		sunTexture = THREE.ImageUtils.loadTexture( "stars/sun_surface.png", undefined, setLoadMessage("Igniting solar plasma") );
		sunTexture.anisotropy = maxAniso;
		sunTexture.wrapS = sunTexture.wrapT = THREE.RepeatWrapping;
	}

	if( sunColorLookupTexture === undefined ){
		sunColorLookupTexture = THREE.ImageUtils.loadTexture( "stars/star_colorshift.png" );
	}

	if( solarflareTexture === undefined ){
		solarflareTexture = THREE.ImageUtils.loadTexture( "stars/solarflare.png", undefined, setLoadMessage("Distributing solar flares")	 );
	}

	if( sunHaloTexture === undefined ){
		sunHaloTexture = THREE.ImageUtils.loadTexture( "stars/sun_halo.png", undefined, setLoadMessage("Calculating coronal mass") );
	}

	if( sunHaloColorTexture === undefined ){
		sunHaloColorTexture = THREE.ImageUtils.loadTexture( "stars/halo_colorshift.png" );
	}

	if( sunCoronaTexture === undefined ){
		sunCoronaTexture = THREE.ImageUtils.loadTexture( "stars/corona.png", undefined, setLoadMessage("Projecting coronal ejecta") );
	}
}
